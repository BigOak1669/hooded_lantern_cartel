...
Explorer({
  sortFn: (a: ExplorerNode, b: ExplorerNode) => {
    ...
    const aOrder =
      typeof aFrontmatter?.nav_order === "number" ? aFrontmatter.nav_order : Number.MAX_SAFE_INTEGER
    const bOrder =
      typeof bFrontmatter?.nav_order === "number" ? bFrontmatter.nav_order : Number.MAX_SAFE_INTEGER
